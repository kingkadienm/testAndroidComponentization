package com.wangzs.jetpackmvvm.demo.app.weight.customview
...
import com.wangzs.jetpackmvvm.demo.ui.adapter.PriorityAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view.findViewById<RecyclerView>(R.id.tododialog_recycler).apply {
            context?.let {
                ...
                addItemDecoration(
                    _root_ide_package_.com.wangzs.jetpackmvvm.demo.app.weight.recyclerview.GridDividerItemDecoration(
                        it,
                        0,
