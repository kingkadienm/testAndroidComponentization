package com.wangzs.jetpackmvvm.demo.ui.fragment.setting
...
import com.wangzs.jetpackmvvm.demo.app.event.AppViewModel
import com.wangzs.jetpackmvvm.demo.app.ext.initClose
import com.wangzs.jetpackmvvm.demo.app.ext.showMessage
import com.wangzs.jetpackmvvm.demo.app.network.NetworkApi
import com.wangzs.jetpackmvvm.demo.app.util.CacheDataManager
...
import com.wangzs.jetpackmvvm.demo.app.weight.preference.IconPreference
import com.wangzs.jetpackmvvm.demo.data.model.bean.BannerResponse
import com.wangzs.jetpackmvvm.ext.getAppViewModel
...
class SettingFragment : PreferenceFragmentCompat(),
            ...
            activity?.let { activity ->
                MaterialDialog(activity).show {
                    ...
                    colorChooser(
                        ...
                        findPreference<_root_ide_package_.com.wangzs.jetpackmvvm.demo.app.weight.preference.PreferenceCategory>("base")?.setTitleColor(color)
                        findPreference<_root_ide_package_.com.wangzs.jetpackmvvm.demo.app.weight.preference.PreferenceCategory>("other")?.setTitleColor(color)
                        findPreference<_root_ide_package_.com.wangzs.jetpackmvvm.demo.app.weight.preference.PreferenceCategory>("about")?.setTitleColor(color)
                        findPreference<_root_ide_package_.com.wangzs.jetpackmvvm.demo.app.weight.preference.CheckBoxPreference>("top")?.setBottonColor()
    ...
    private fun setText() {
        activity?.let {
            ...
            findPreference<_root_ide_package_.com.wangzs.jetpackmvvm.demo.app.weight.preference.CheckBoxPreference>("top")?.isChecked = CacheUtil.isNeedTop()
